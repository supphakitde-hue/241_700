...
console..log('log('name',fname , 'age' , age)
//console.log('age', age)
*/
/*
== เท่ากับ
...
console.log('resulty= of condition', condition)
...
for (let index = 0; index < student.length; index++){
    ...
    console.log('age',studnet[index].name)
    console.log('name',studnet[index].name)
    console.log('grade',studnet[index].name)
...
let student =studnets.find(() => {
    if (s.name == aa){
        return true
    }
})
let double_score =student.map(() => {
    s.score=s.score * 2
    return s
})
